...
export const RECOMMENDED_PLACES: DestinationTrip[] = [
  {
    ...
    whyPickedTranslations: {
      ...
      kn: 'ನಿಮ್ಮ ವಿಶ್ರಾಂತಿ ಪ್ರಯಾಣ ಶೈಲಿ ಮತ್ತು ಮೂನ್ನಾರ್ ಆದ್ಯತೆಗೆ ಸೂಕ್ತವಾಗಿದೆ, ₹10,000 ಬಜೆಟ್‌ ಒಳಗಡೆ ನೈಸರ್ಗಿಕ ಕಣಿವೆಯ ಸುಂದರ ದೃಶ್ಯಗಳೊಂದಿಗೆ.'
    },
    signals: {
  ...
  },
  {
    ...
    whyPickedTranslations: {
      ...
      kn: 'ಶಾಂತ ಪರಿಸರ, ಮನೆಯಲ್ಲಿ ತಯಾರಿಸಿದ ಕೇರಳದ ರುಚಿಕರ ಊಟ ಮತ್ತು ಬೆಳಗಿನ ಪಕ್ಷಿ ವೀಕ್ಷಣೆ ಹಾದಿಗಳಿಗೆ ಅತ್ಯುತ್ತಮ ಆಯ್ಕೆ.'
    },
    signals: {
  ...
  },
  {
    ...
    whyPickedTranslations: {
      ...
      kn: 'ಪ್ರವಾಸಿ ವಾಹನಗಳ ದಟ್ಟಣೆಯಿಲ್ಲದೆ ನಿಮ್ಮ ಶಾಂತಿ ಆದ್ಯತೆಯನ್ನು ಪೂರೈಸುವ ಖಾಸಗಿ ಬಾಲ್ಕನಿಗಳು ಮತ್ತು ಅದ್ಭುತ ಪರ್ವತ ದೃಶ್ಯಗಳಿಗೆ ಹೆಸರುವಾಸಿ.'
    },
    signals: {
